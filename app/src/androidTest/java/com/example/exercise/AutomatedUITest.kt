package com.aiilluminati.rehab360
...
class AutomatedUITest {
    ...
    fun setUp() {
        ...
        val intent =
            context.packageManager.getLaunchIntentForPackage("com.aiilluminati.rehab360")?.apply {
        ...
        device.wait(
            Until.hasObject(By.pkg("com.aiilluminati.rehab360").depth(0)),
            5000
        )
    }
    ...
    fun onBoardingTest() {
        ...
        device.wait(Until.hasObject(By.res("com.aiilluminati.rehab360:id/onboardingLayout")),10000)
        // Click on the next button
        device.findObject(By.res("com.aiilluminati.rehab360:id/nextButton")).click()
